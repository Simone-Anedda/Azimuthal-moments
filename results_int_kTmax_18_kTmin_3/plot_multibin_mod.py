...
BINS = [
    ...
    {"label": r"$0.5 < z_1 < 0.7$", "file": "kT_max_18_kT_min_3_Vs_92_thetac_0.03_z1_0.5_0.7_U_L.txt"},
    {"label": r"$0.7 < z_1 < 0.9$", "file": "kT_max_18_kT_min_3_Vs_92_thetac_0.03_z1_0.7_0.9_U_L.txt"},
]
